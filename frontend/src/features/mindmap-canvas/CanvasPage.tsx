  ...
  const handleAddNode = useCallback((type: string, parentId: string | null = null) => {
    const newNode: Node = {
      ...
      data: {
        ...
        aiDescriptionEnabled: false,
        order: 0,
        level: parentId ? nodes.find(n => n.id === parentId)?.data.level! + 1 : 0
      },
      parentId
    }
      ...
      <Content style={{ padding: '24px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
          ...
          <div>
            ...
            <Button type="primary" icon={<EyeOutlined />} style={{ marginRight: '8px' }} onClick={handleAssembleSlides}>
              组装幻灯片
            </Button>
